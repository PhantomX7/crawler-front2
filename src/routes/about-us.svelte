<div class="max-w-4xl mt-5 flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
	<!--Main Col-->
	<div
		id="profile"
	...
	>
		<div class="p-4 md:p-12 text-center lg:text-left">
			...
			<p class="pt-8 text-sm">Kami memberikan informasi seputar apa yang terjadi di Indonesia</p>
